<div class="min-h-screen py-10 px-4 text-white">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <!-- Tombol Back diarahkan ke halaman kategori -->
        ...
        <!-- FORM -->
        <form wire:submit.prevent="createKategori" class="bg-white/5 border border-white/10 backdrop-blur-2xl rounded-3xl p-6 md:p-10 shadow-2xl space-y-8">
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-white/5">
                ...
                <button type="submit" wire:loading.attr="disabled"
                    ...
                    <span wire:loading.remove wire:target="createKategori">Create Category</span>
                    
                    <span wire:loading wire:target="createKategori" class="flex items-center">
