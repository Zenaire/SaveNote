        ...
        <form wire:submit.prevent="update"
            ...
            <div class="space-y-2">
                <label class="text-sm font-medium text-gray-400 ml-1">
                    Folder Name <span class="text-blue-500">*</span>
                </label>
            ...
            <!-- FOLDER THUMBNAIL -->
            <div class="space-y-2">
                <label class="text-sm font-medium text-gray-400 ml-1">Folder Thumbnail</label>
                ...
                <div class="relative group">
                    ...
                    <!-- PREVIEW IMAGE -->
                    @if ($thumbnail)
                        <!-- Preview jika ada file baru yang diunggah -->
                    ...
                    @elseif($oldThumbnail)
                        <!-- Preview thumbnail lama dari database -->
                        <div class="mt-4 relative inline-block opacity-80 hover:opacity-100 transition-opacity">
                            <img src="{{ asset('storage/' . $oldThumbnail) }}" class="h-32 w-48 object-cover rounded-xl border border-white/20 shadow-lg">
                        </div>
                    @endif
