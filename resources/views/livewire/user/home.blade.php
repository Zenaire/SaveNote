        ...
        <div class="relative z-10 p-8">
            ...
            <div class="grid md:grid-cols-3 gap-4 mb-8">
                ...
                <div class="md:col-span-2">
                    ...
                    <a class="bg-gradient-to-r bg-blue-500  px-3 py-3 rounded-2xl font-semibold shadow-lg shadow-blue-500/20 hover:bg-blue-600 transition"
                        href="/folders">
                        Folders
                    </a>
                </div>
                ...
                <div class="mb-10" wire:key="category-{{ $categoryId ?: 'uncategorized' }}">
                    ...
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        <div class="flex ml-auto">
                            <a href="/kategori">
                                <button
                                    class="text-lg bg-white/5 border border-white/10 px-2 py-2 text-white rounded-xl  hover:text-blue-300 transition">
                                    New Category +
                                </button>
                            </a>
                        </div>
