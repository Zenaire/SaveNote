    ...
    <div class="min-h-screen relative overflow-hidden bg-[#0f0f17] text-white">
        ...
        <div class="relative z-10 p-8">
            ...
            <div class="flex items-center justify-between mb-10">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <a href="/profile" class="text-white font-semibold bg-gradient-to-r bg-blue-500 px-4 py-2 rounded-2xl shadow-lg shadow-blue-500/20 hover:bg-blue-600 transition">Profile</a>
                    </div>

                    <a class="bg-gradient-to-r bg-blue-500  px-6 py-3 rounded-2xl font-semibold shadow-lg shadow-blue-500/20 hover:bg-blue-600 transition" href="/newNote">
                        + New Note
                    </a>
                    <button wire:click="logout" class="bg-white/5 border  border-white/10 backdrop-blur-xl px-5 py-3 rounded-2xl hover:bg-white/10 transition">
                        Logout
                    </button>
            ...
            <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 items-stretch">
                ...
                @forelse($notes->groupBy('category_id') as $categoryId => $notesGroup)

                <div class="mb-10" wire:key="category-{{ $categoryId ?: 'uncategorized' }}">

                    <div class="flex items-center gap-3 mb-5">
                        <div class="w-2 h-2 rounded-full bg-blue-400"></div>

                        <h2 class="text-xl font-bold text-white">
                            {{ $notesGroup->first()?->category?->name ?? 'No Category' }}
                        </h2>

                        <span class="text-xs text-gray-500">
                            ({{ $notesGroup->count() }} notes)
                        </span>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        @foreach($notesGroup as $note)
                            ...
                            <div wire:key="note-{{ $note->id }}" class="bg-white/5 border border-white/10 backdrop-blur-2xl rounded-[28px] p-6 hover:border-blue-400/30 hover:-translate-y-1 transition duration-300 shadow-2xl shadow-black/20 flex flex-col h-full overflow-hidden relative">
                                ...
                                <div class="-mx-6 -mt-6 mb-5 h-48 shrink-0 relative border-b border-white/10 bg-gradient-to-br from-white/5 to-blue-500/10 flex items-center justify-center p-6 text-center overflow-hidden group">
                                    ...
                                    <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-500/10 via-transparent to-transparent opacity-50">
                                    </div>
                                ...
                                <div class="flex items-start justify-between mb-4 min-h-[28px]">
                                    ...
                                    <div class="flex gap-3 text-sm shrink-0">
                                        <a href="/edit/{{ $note->id }}" class="text-zinc-400 hover:text-white transition">
                                            Edit
                                        </a>

                                        <button wire:click="destroy('{{ $note->id }}')" class="text-red-400 hover:text-red-300 transition">
                                            Delete
                                        </button>
                                    </div>
                ...
                <div wire:key="empty-state-notes" class="col-span-full flex flex-col items-center justify-center py-16 text-center bg-white/5 border border-white/10 rounded-[28px] backdrop-blur-sm">
                    ...
                    <p class="text-gray-400 text-sm">
                        Tulis ide pertamamu sekarang juga!
                    </p>
